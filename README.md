...
resource and answer key filenames. The CSV export writes the same ordered path
as one row per resource so course packs and tutoring pathways can be sorted,
filtered, and edited in spreadsheet tools.
